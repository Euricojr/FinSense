const translations = {
  pt: {
    ...
    edu_pred_engine_title: "O Algoritmo",
    edu_pred_engine_desc: "O Random Forest combina os resultados de 100 árvores de decisão para minimizar a variância e evitar o overfitting (superajuste).",
    edu_pred_features_title: "Feature Engineering",
    edu_pred_features_desc: "O regressor processa vetores de Tendência (MM), Momentum (RSI) e Volatilidade Histórica para identificar padrões não-lineares.",
    edu_pred_train_title: "Aprendizado Supervisionado",
    edu_pred_train_desc: "Utilizamos dados históricos rotulados para treino e validamos a generalização em um conjunto de teste (Backtesting) via R² Score.",
    edu_pred_snowball_title: "Recursividade Univariada",
    edu_pred_snowball_desc: "A projeção de múltiplos passos é gerada retroalimentando as previsões de curto prazo como inputs para os dias subsequentes.",
    edu_pred_funnel_title: "Intervalo de Confiança",
    edu_pred_funnel_desc: "A área sombreada representa a incerteza estatística (95%), calculada a partir da distribuição dos resíduos (erros) do modelo.",
  ...
  en: {
    ...
    edu_pred_engine_title: "The Algorithm",
    ...
    edu_pred_train_title: "Supervised Learning",
    ...
    edu_pred_snowball_title: "Univariate Recursion",
    ...
    edu_pred_funnel_title: "Confidence Interval",
